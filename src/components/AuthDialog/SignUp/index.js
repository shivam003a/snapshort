...
export default function SignUp({ name, setName, email, setEmail, password, setPassword }) {
    return (
        <div className="w-full px-3 py-6 pb-10 bg-cs-blue-light flex flex-col gap-4">
