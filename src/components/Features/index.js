...
export default function Features() {
    return (
        <div className="w-full max-w-[1200px] mx-auto flex flex-col md:flex-row justify-center items-stretch gap-4 px-2 py-16">
            ...
            <div className="flex-3/4 flex flex-col md:flex-row gap-12 px-8 relative">
                ...
                <div className="hidden md:block bg-cs-blue-dark h-14 w-full absolute -bottom-13"></div>
            </div>
        </div>
    )
}